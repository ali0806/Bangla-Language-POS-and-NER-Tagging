...
parser.add_argument('--cnn_out_channels', type=int, default=30, help='Number of output channels for CNN.')
parser.add_argument('--cnn_kernel_size', type=int, default=3, help='Kernel size for CNN.')
...
with open('model/tag_mappings.json', 'w', encoding='utf-8') as f:
...
with open('model/model_params.json', 'w', encoding='utf-8') as f:
...
plt.savefig('media/training_loss_curve.png')
